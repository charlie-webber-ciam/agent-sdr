...
export default function MessagingSection({
  ...
  const handleGenerate = async () => {
    setGenerating(true);
    try {
      const res = await fetch(`/api/accounts/${accountId}/generate-messaging`, {
        method: 'POST',
      ...
      console.error('Failed to generate messaging:', err);
    } finally {
      setGenerating(false);
    }
  };
        ...
        <div className="flex w-full items-center justify-between px-5 py-3">
          <CollapsibleTrigger asChild>
            <button className="flex items-center gap-2 text-left">
              ...
              <span className="text-sm font-medium text-gray-900">Core Messaging</span>
              ...
              {saveStatus === 'idle' && text && <span className="rounded-full bg-purple-100 px-2 py-0.5 text-[10px] font-medium text-purple-700">Has content</span>}
            </button>
          </CollapsibleTrigger>
          <Button
            size="sm"
          ...
          <div className="border-t border-gray-100 px-5 py-4 space-y-3">
            {existingMessage && (
              <div>
                ...
                >
                  ...
                  Existing Command of the Message
                </button>
                {showExisting && (
            ...
            {text && !editing ? (
              ...
              <Textarea
                ...
                placeholder="Core messaging for this account — value props, pain points, recommended angles..."
