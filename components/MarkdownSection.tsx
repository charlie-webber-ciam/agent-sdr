...
export default function MarkdownSection({
  ...
  return (
    <div id={id} className="mb-8 scroll-mt-24">
      ...
      <div className={`relative bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow ${isRerunning ? 'min-h-[120px]' : ''}`}>
        {isRerunning && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 rounded-xl bg-white/80 backdrop-blur-[2px]">
            ...
            <span className="text-sm font-medium text-gray-500">Regenerating research...</span>
          </div>
        )}
        {content ? (
