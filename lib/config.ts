...
export const PROCESSING_CONFIG = {
  ...
  enableParallel: process.env.ENABLE_PARALLEL_PROCESSING === 'true',
...
export function validateConfig(): void {
  ...
  if (concurrency < 1 || concurrency > 10) {
    console.warn(`Invalid PROCESSING_CONCURRENCY: ${concurrency}. Using default: 5`);
    (PROCESSING_CONFIG as any).concurrency = 5;
  }
